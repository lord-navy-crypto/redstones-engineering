...
for verifier,label in ((SYSTEMS_VERIFY,"engineering systems"),(LIVE_OUTPUT_VERIFY,"live output bars"),(HANDHELD_VERIFY,"handheld tools"),(SIGNAL_PROCESSOR_VERIFY,"signal processor HMI"),(PID_COMMISSIONING_VERIFY,"PID commissioning HMI"),(PNEUMATIC_GOLDEN_VERIFY,"pneumatic Golden System"),(INDUSTRIAL_OPERATIONS_VERIFY,"Industrial Operations foundation"),(ROBOTICS_FOUNDATION_VERIFY,"Robotics foundation"),(MOBILE_ROBOT_VERIFY,"mobile robot entity"),(ROBOTICS_NAVIGATION_VERIFY,"robotics navigation network"),(ROBOTICS_DOCK_VERIFY,"robotics dock foundation")):

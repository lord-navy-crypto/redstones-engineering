...
if errors:
    print("RSE 127-BLOCK AGGREGATE CLOSURE VERIFY: FAIL")
    for e in errors: print(" -",e)
    sys.exit(1)
print("RSE 127-BLOCK AGGREGATE CLOSURE VERIFY: PASS")
print("  historical deep-audit core: 122")
print("  systems extension: 5")
print("  systems closure: sequence controller, safety interlock, fault injector, alarm processor, topology debugger")

...
if errors:
    print("RSE 134-BLOCK AGGREGATE CLOSURE VERIFY: FAIL")
    for e in errors: print(" -",e)
    sys.exit(1)
print("RSE 134-BLOCK AGGREGATE CLOSURE VERIFY: PASS")
print("  historical deep-audit core: 122")
print("  core-redstone extension: 4")
...
print("  Industrial Operations world: workcell controller + persisted logical WIP buffer")

...
if workflow:
    ...
    if not thresholds or max(thresholds) < 279:
        errors.append("workflow GameTest floor must be at least 279")
...
print("  ten executable ninth-ten GameTests registered: PASS")

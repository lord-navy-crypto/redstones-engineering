# RSE alpha.7.1 Stability Hotfix

This hotfix addresses startup and runtime pressure discovered in alpha.6/alpha.7.
...
Approximate enumerated RSE states after hotfix: ~3,700.

 ...
 * This module follows the same DeferredRegister lifecycle as the core, so no Block or
 * BlockItem is instantiated during mod class initialization after vanilla registries freeze.</p>
 */
...
public final class EngineeringSystemsModule {
    ...
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(RedstoneEngineering.MOD_ID);
    public static final DeferredRegister.Items ITEMS =
            DeferredRegister.createItems(RedstoneEngineering.MOD_ID);

    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<SequenceControllerBlock>>
            SEQUENCE_CONTROLLER_CODEC = codec("sequence_controller", SequenceControllerBlock::new);
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<SafetyInterlockBlock>>
            SAFETY_INTERLOCK_CODEC = codec("safety_interlock", SafetyInterlockBlock::new);
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<FaultInjectorBlock>>
            FAULT_INJECTOR_CODEC = codec("fault_injector", FaultInjectorBlock::new);

    public static final DeferredBlock<SequenceControllerBlock> SEQUENCE_CONTROLLER =
            BLOCKS.registerBlock("sequence_controller", SequenceControllerBlock::new,
                    machineProps(MapColor.COLOR_PURPLE));
    public static final DeferredBlock<SafetyInterlockBlock> SAFETY_INTERLOCK =
            BLOCKS.registerBlock("safety_interlock", SafetyInterlockBlock::new,
                    machineProps(MapColor.COLOR_RED));
    public static final DeferredBlock<FaultInjectorBlock> FAULT_INJECTOR =
            BLOCKS.registerBlock("fault_injector", FaultInjectorBlock::new,
                    machineProps(MapColor.COLOR_ORANGE));

    public static final DeferredItem<BlockItem> SEQUENCE_CONTROLLER_ITEM =
            ITEMS.registerSimpleBlockItem("sequence_controller", SEQUENCE_CONTROLLER);
    public static final DeferredItem<BlockItem> SAFETY_INTERLOCK_ITEM =
            ITEMS.registerSimpleBlockItem("safety_interlock", SAFETY_INTERLOCK);
    public static final DeferredItem<BlockItem> FAULT_INJECTOR_ITEM =
            ITEMS.registerSimpleBlockItem("fault_injector", FAULT_INJECTOR);
    ...
    public static String summary() {
        return "Engineering Systems: Sequence / Interlock / Fault Injection";
    }
}

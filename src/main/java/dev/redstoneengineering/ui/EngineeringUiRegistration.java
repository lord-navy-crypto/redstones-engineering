...
public final class EngineeringUiRegistration {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<IndustrialBufferMenu>> INDUSTRIAL_BUFFER = MENUS.register("industrial_buffer", () -> IMenuTypeExtension.create(IndustrialBufferMenu::new));
